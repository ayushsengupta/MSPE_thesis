function [irdSOH, irdSOC, irreld_pt5, irreld_10, irreld_30, legend_ird] = irrel_dis_cycle_CEA(p,g)
...
% and the legend matrix    
    ...
    irreld_pt5 = dcharge_ir(3:5:end-2,:)/g
    irreld_10 = dcharge_ir(4:5:end-1,:)/g
    irreld_30 = dcharge_ir(5:5:end,:)/g
    [x,y] = size(irdSOC)
    for a=1:x
        for b=1:y
            ...
            elseif (a==x && irdSOC(a,b)==0 && irreld_pt5(a,b)==0 && irreld_10(a,b) == 0 && irreld_30(a,b) == 0 )
                irdSOC(a,b) = NaN
                irreld_pt5(a,b)= NaN
                irreld_10(a,b) = NaN
                irreld_30(a,b) = NaN
