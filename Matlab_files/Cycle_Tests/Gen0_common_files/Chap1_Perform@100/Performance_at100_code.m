...
for n=1:(j/2)
    ...
    if(n==1)
        ...
        plot(irSOC_av, ir_pt5_av,'r-.d', 'LineWidth', 1)
        hold on
        plot(irSOC_av, ir_10_av, 'r-o', 'LineWidth', 1)
        hold on
        plot(irSOC_av, ir_30_av, 'r-+', 'LineWidth', 1)
        hold on
        subleg1_cyl = strcat('Cylindrical at 0.5s')
        subleg2_cyl = strcat('Cylindrical at 10s')
        subleg3_cyl = strcat('Cylindrical at 30s')
    end
    if (n==3)
        ...
        ir_10_av(1,:) = (ir_10(1,:)+ ir_10(2,:))/2
        ir_30_av(1,:) = (ir_30(1,:)+ ir_30(2,:))/2
        plot(irSOC_av, ir_pt5_av,'g-.d','LineWidth', 1)
        hold on
        plot(irSOC_av, ir_10_av, 'g-o','LineWidth', 1)
        hold on
        plot(irSOC_av, ir_30_av, 'g-+','LineWidth', 1)
        hold on
        subleg1_prism = strcat('Prismatic at 0.5s')
        subleg2_prism = strcat('Prismatic at 10s')
        subleg3_prism = strcat('Prismatic at 30s')
    end
    if (n==5)
        ...
        ir_10_av(1,:) = (ir_10(1,:)+ ir_10(2,:))/2
        ir_30_av(1,:) = (ir_30(1,:)+ ir_30(2,:))/2
        plot(irSOC_av, ir_pt5_av,'k-.d','LineWidth', 1)
        hold on
        plot(irSOC_av, ir_10_av, 'k-o','LineWidth', 1)
        hold on
        plot(irSOC_av, ir_30_av, 'k-+','LineWidth', 1)
        hold on
        subleg1_pouch = strcat('Pouch at 0.5s')
        subleg2_pouch = strcat('Pouch at 10s')
        subleg3_pouch = strcat('Pouch at 30s')
    end
end
hold off
legend_ir_100 = strvcat(subleg1_cyl, subleg2_cyl, subleg3_cyl, subleg1_prism, subleg2_prism, subleg3_prism, subleg1_pouch, subleg2_pouch, subleg3_pouch)
xlim([0 100])
...
for n=1:(j/2)
    ...
    if(n==1)
        ...
        plot(irdSOC_av, ird_pt5_av,'r-.d','LineWidth', 1)
        hold on
        plot(irdSOC_av, ird_10_av, 'r-o','LineWidth', 1)
        hold on
        plot(irdSOC_av, ird_30_av, 'r-+','LineWidth', 1)
        hold on
        subleg1d_cyl = strcat('Cylindrical at 0.5s')
        subleg2d_cyl = strcat('Cylindrical at 10s')
        subleg3d_cyl = strcat('Cylindrical at 30s')
    end
    if (n==3)
        [ird_SOH(1,:), irdSOC(1,:), ird_pt5(1,:), ird_10(1,:), ird_30(1,:)] = ir_dis_cycle_CID_100(Filepath(2*k-1,:));
        k=k+1
        ...
        ird_10_av(1,:) = (ird_10(1,:)+ ird_10(2,:))/2
        ird_30_av(1,:) = (ird_30(1,:)+ ird_30(2,:))/2
        plot(irdSOC_av, ird_pt5_av,'g-.d','LineWidth', 1)
        hold on
        plot(irdSOC_av, ird_10_av, 'g-o','LineWidth', 1)
        hold on
        plot(irdSOC_av, ird_30_av, 'g-+','LineWidth', 1)
        hold on
        subleg1d_prism = strcat('Prismatic at 0.5s')
        subleg2d_prism = strcat('Prismatic at 10s')
        subleg3d_prism = strcat('Prismatic at 30s')
    end
    if (n==5)
        ...
        ird_10_av(1,:) = (ird_10(1,:)+ ird_10(2,:))/2
        ird_30_av(1,:) = (ird_30(1,:)+ ird_30(2,:))/2
        plot(irdSOC_av, ird_pt5_av,'k-.d','LineWidth', 1)
        hold on
        plot(irdSOC_av, ird_10_av, 'k-o','LineWidth', 1)
        hold on
        plot(irdSOC_av, ird_30_av, 'k-+','LineWidth', 1)
        hold on
        subleg1d_pouch = strcat('Pouch at 0.5s')
        subleg2d_pouch = strcat('Pouch at 10s')
        subleg3d_pouch = strcat('Pouch at 30s')
    end
end
hold off
legend_ird_100 = strvcat(subleg1d_cyl, subleg2d_cyl, subleg3d_cyl, subleg1d_prism, subleg2d_prism, subleg3d_prism, subleg1d_pouch, subleg2d_pouch, subleg3d_pouch)
xlim([0 100])
ylabel('Internal resistance (mOhm)')
xlabel('State of Charge (%)')
