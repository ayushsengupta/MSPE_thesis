...
for n=1:(j/2)
    ...
    if(n==1)
        ...
        leg_rel1 = strcat(legend_com(n),cellstr(num2str(ir_SOH_av_cyl_5(1,2)', ', increment at SOH = %f')))
    ...
    if (n==2)
        ...
        leg_rel2 = strcat(legend_com(n),cellstr(num2str(ir_SOH_av_cyl_45(1,2)', ', increment at SOH = %f')))
    end
    if (n==3)
        [ir_SOH1(:,:), irSOC1(:,:), ir_pt51_rel(:,:), ir_101_rel(:,:), ir_301_rel(:,:)] = ir_ch_cycle_CID_rel(Filepath(2*k-1,:));
        k=k+1
        ...
        leg_rel3 = strcat(legend_com(n), cellstr(num2str(ir_SOH_av_prism_5(1,2)', ', increment at SOH = %f')))
    end
    if (n==4)
        ...
        leg_rel4 = strcat(legend_com(n), cellstr(num2str(ir_SOH_av_prism_45(1,2)', ', increment at SOH = %f')))
    end
    if (n==5)
        ...
        leg_rel5 = strcat(legend_com(n),cellstr(num2str(ir_SOH_av_pouch_5(1,2)', ', increment at SOH = %f')))
    ...
    if (n==6)
        ...
        leg_rel6 = strcat(legend_com(n),cellstr(num2str(ir_SOH_av_pouch_45(1,2)', ', increment at SOH = %f')))
    ...
    figure()
    plot(irSOC_av_cyl_5(:,2), ir_pt5_av_cyl_5, '-+')
    hold on
    plot(irSOC_av_cyl_45(:,2), ir_pt5_av_cyl_45, '-h')
    hold on
    plot(irSOC_av_prism_5(:,2), ir_pt5_av_prism_5, '-*')
    hold on
    plot(irSOC_av_prism_45(:,2), ir_pt5_av_prism_45, '-s')
    hold on
    plot(irSOC_av_pouch_5(:,2), ir_pt5_av_pouch_5, '-o')
    hold on
    plot(irSOC_av_pouch_45(:,2), ir_pt5_av_pouch_45, '-v')
    xlim([0 100])
    legend(legrel, 'Location', 'NorthWest')
    xlabel('State of Charge (%)')
    ylabel('Internal resistance increment with respect to 100% SOH (BOL)')
    title('Ageing effect at the 0.5s instant of a 30 s CHARGING pulse')

% for the 10s instant
    figure()
    plot(irSOC_av_cyl_5(:,2), ir_10_av_cyl_5, '-+')
    hold on
    plot(irSOC_av_cyl_45(:,2), ir_10_av_cyl_45, '-h')
    hold on
    plot(irSOC_av_prism_5(:,2), ir_10_av_prism_5, '-*')
    hold on
    plot(irSOC_av_prism_45(:,2), ir_10_av_prism_45, '-s')
    hold on
    plot(irSOC_av_pouch_5(:,2), ir_10_av_pouch_5, '-o')
    hold on
    plot(irSOC_av_pouch_45(:,2), ir_10_av_pouch_45, '-v')
    xlim([0 100])
    legend(legrel, 'Location', 'NorthWest')
    xlabel('State of Charge (%)')
    ylabel('Internal resistance increment with respect to 100% SOH (BOL)')
    title('Ageing effect at the 10s instant of a 30 s CHARGING pulse')

    % for the 30s instant
    figure()
    plot(irSOC_av_cyl_5(:,2), ir_30_av_cyl_5, '-+')
    hold on
    plot(irSOC_av_cyl_45(:,2), ir_30_av_cyl_45, '-h')
    hold on
    plot(irSOC_av_prism_5(:,2), ir_30_av_prism_5, '-*')
    hold on
    plot(irSOC_av_prism_45(:,2), ir_30_av_prism_45, '-s')
    hold on
    plot(irSOC_av_pouch_5(:,2), ir_30_av_pouch_5, '-o')
    hold on
    plot(irSOC_av_pouch_45(:,2), ir_30_av_pouch_45, '-v')
    xlim([0 100])
    legend(legrel, 'Location', 'NorthWest')
    xlabel('State of Charge (%)')
    ylabel('Internal resistance increment with respect to 100% SOH (BOL)')
    title('Ageing effect at the 30s instant of a 30s CHARGING pulse')
...
for n=1:(j/2)
    ...
    % for the 0.5s instant
    figure()
    plot(irdSOC_av_cyl_5(:,2), ird_pt5_av_cyl_5, '-+')
    hold on
    plot(irdSOC_av_cyl_45(:,2), ird_pt5_av_cyl_45, '-h')
    hold on
    plot(irdSOC_av_prism_5(:,2), ird_pt5_av_prism_5, '-*')
    hold on
    plot(irdSOC_av_prism_45(:,2), ird_pt5_av_prism_45, '-s')
    hold on
    plot(irdSOC_av_pouch_5(:,2), ird_pt5_av_pouch_5, '-o')
    hold on
    plot(irdSOC_av_pouch_45(:,2), ird_pt5_av_pouch_45, '-v')
    xlim([0 100])
    ylim([0 1.8])
    legend(legreld, 'Location', 'NorthWest')
    xlabel('State of Charge (%)')
    ylabel('Internal resistance increment with respect to 100% SOH (BOL)')
    title('Ageing effect at the 0.5s instant of a 30s DISCHARGING pulse')

% for the 10s instant
    figure()
    plot(irdSOC_av_cyl_5(:,2), ird_10_av_cyl_5, '-+')
    hold on
    plot(irdSOC_av_cyl_45(:,2), ird_10_av_cyl_45, '-h')
    hold on
    plot(irdSOC_av_prism_5(:,2), ird_10_av_prism_5, '-*')
    hold on
    plot(irdSOC_av_prism_45(:,2), ird_10_av_prism_45, '-s')
    hold on
    plot(irdSOC_av_pouch_5(:,2), ird_10_av_pouch_5, '-o')
    hold on
    plot(irdSOC_av_pouch_45(:,2), ird_10_av_pouch_45, '-v')
    xlim([0 100])
    ylim([0 1.8])
    legend(legreld, 'Location', 'NorthWest')
    xlabel('State of Charge (%)')
    ylabel('Internal resistance increment with respect to 100% SOH (BOL)')
    title('Ageing effect at the 10s instant of a 30s DISCHARGING pulse')

    % for the 30s instant
    figure()
    plot(irdSOC_av_cyl_5(:,2), ird_30_av_cyl_5, '-+')
    hold on
    plot(irdSOC_av_cyl_45(:,2), ird_30_av_cyl_45, '-h')
    hold on
    plot(irdSOC_av_prism_5(:,2), ird_30_av_prism_5, '-*')
    hold on
    plot(irdSOC_av_prism_45(:,2), ird_30_av_prism_45, '-s')
    hold on
    plot(irdSOC_av_pouch_5(:,2), ird_30_av_pouch_5, '-o')
    hold on
    plot(irdSOC_av_pouch_45(:,2), ird_30_av_pouch_45, '-v')
    xlim([0 100])
    ylim([0 1.8])
    legend(legreld, 'Location', 'NorthWest')
    xlabel('State of Charge (%)')
    ylabel('Internal resistance increment with respect to 100% SOH (BOL)')
    title('Ageing effect at the 30s instant of a 30s DISCHARGING pulse')
